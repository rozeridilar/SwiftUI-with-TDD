...
/*
Apple defines hashable as a type that provides an integer a hash value which is provided by a type’s hashValue property and it is basically an integer that is the same for any two instances that compare equally.
